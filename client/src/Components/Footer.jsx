        ...
        <footer className="bg-[#1a1a1a] text-white py-12 px-4">
            <div className="container mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div className="flex flex-col space-y-4">
                        ...
                        <div className="flex space-x-4 mt-4">
                            <a href="https://www.facebook.com/share/14QTeG1vVgu/?mibextid=wwXIfr" className="text-white hover:text-red-500 transition-colors">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    className="h-5 w-5"
                                    fill="currentColor"
                ...
                <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400 text-sm">
                    <p>© 2025 StreamPhim. Tất cả các quyền được bảo lưu.</p>
                </div>
            </div>
